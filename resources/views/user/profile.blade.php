<x-layout>
  ...
  <main class="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        <h1 id="user-header-nickname" class="text-3xl font-extrabold text-gray-900"></h1>

        <!-- Меню навигации личного кабинета -->
        <div class="mt-4 border-b border-gray-200">
          <nav class="-mb-px flex space-x-8">
            <a href="{{ route('profile') }}" class="border-indigo-600 text-indigo-600 whitespace-nowrap py-4 px-1 border-b-2 font-semibold text-sm">
              Персональные данные
            </a>
